...
The search setting `exhaustive` tells the benchmark to test all possible inputs in the function's input domain, provided exactly in [functions.jl](./functions.jl) for a particular floating-point format.
