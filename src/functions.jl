...
const functions_dict = Dict{String, Dict}(
    "binary16" => binary16_functions,
    "binary32" => binary32_functions,
    "binary64" => binary64_functions,
)

const spec_inputs_dict = Dict{String, Dict}(
    "binary16" => Dict{String, Vector{Float16}}(),  # none
    "binary32" => binary32_functions_spec_inputs,
    "binary64" => binary64_functions_spec_inputs,
)

const format_name = Dict(
    Float16 => "binary16",
    Float32 => "binary32",
    Float64 => "binary64",
)
...
binary16_functions["log"]   = (min_binary16, max_binary16)
binary16_functions["log10"] = (min_binary16, max_binary16)
binary16_functions["log1p"] = (nextfloat(Float16(-1)), max_binary16)
binary16_functions["log2"]  = (min_binary16, max_binary16)
...
binary32_functions["exp10"] = (-44.853466033935546875, 38.53183746337890625)
binary32_functions["exp2"]  = (-149, 127.99999237060546875)
binary32_functions["log"]   = (min_binary32, max_binary32)
binary32_functions["log10"] = (min_binary32, max_binary32)
binary32_functions["log1p"] = (nextfloat(Float32(-1)), max_binary32)
binary32_functions["log2"]  = (min_binary32, max_binary32)
...
binary32_functions_spec_inputs["acos"]  = Float32.([-0x1.737196p-2, -0x1.0a77f4p-1])
binary32_functions_spec_inputs["acosh"] = Float32.([0x1.0098d6p+13, 0x1.01cb98p+0])
binary32_functions_spec_inputs["asin"]  = Float32.([0x1.001328p-1, 0x1.048506p-1])
binary32_functions_spec_inputs["asinh"] = Float32.([0x1.fffbdep+0, 0x1.0949p-1])
binary32_functions_spec_inputs["atan"]  = Float32.([0x1.bfcf24p-2, 0x1.626772p-1])
binary32_functions_spec_inputs["atanh"] = Float32.([0x1.d921aep-2, 0x1.ec2dd8p-4])
binary32_functions_spec_inputs["cbrt"]  = Float32.([0x1.01ff68p-127, 0x1.c828b4p-127])
binary32_functions_spec_inputs["cos"]   = Float32.([0x1.6d336ep-1, 0x1.921fcp+0])
binary32_functions_spec_inputs["cosh"]  = Float32.([0x1.4f58dap+0, 0x1.65a55ap+6])
binary32_functions_spec_inputs["exp"]   = Float32.([-0x1.638ffap-8, -0x1.2e35b6p+5])
binary32_functions_spec_inputs["exp10"] = Float32.([-0x1.35a566p-9, -0x1.66d3e8p+5])
binary32_functions_spec_inputs["exp2"]  = Float32.([-0x1.fe49bep-8, -0x1.2a0002p+7])
binary32_functions_spec_inputs["log"]   = Float32.([0x1.105602p+0, 0x1.472fdep+0])
binary32_functions_spec_inputs["log10"] = Float32.([0x1.109116p+0, 0x1.52846ep+0])
binary32_functions_spec_inputs["log1p"] = Float32.([0x1.6351d8p+95, 0x1.a827b4p-2])
binary32_functions_spec_inputs["log2"]  = Float32.([0x1.15fde4p+0, 0x1.69cf3ep+0])
binary32_functions_spec_inputs["sin"]   = Float32.([0x1.48776cp+35, 0x1.ffe2a4p+101])
binary32_functions_spec_inputs["sinh"]  = Float32.([0x1.65a55ap+6])
binary32_functions_spec_inputs["sqrt"]  = Float32.([])
binary32_functions_spec_inputs["tan"]   = Float32.([0x1.ff953ep-8, 0x1.921fcp+0])
binary32_functions_spec_inputs["tanh"]  = Float32.([0x1.01b232p+0, 0x1.ddca18p-3])
binary32_functions_spec_inputs["cospi"] = Float32.([0x1.d73b56p-2])
binary32_functions_spec_inputs["sinpi"] = Float32.([0x1.45fcc2p-7])
binary32_functions_spec_inputs["tanpi"] = Float32.([0x1.fe513ep-3])
...
binary64_functions["log"]   = (min_binary64, max_binary64)
binary64_functions["log10"] = (min_binary64, max_binary64)
binary64_functions["log1p"] = (nextfloat(Float64(-1)), max_binary64)
binary64_functions["log2"]  = (min_binary64, max_binary64)
...
binary64_functions_spec_inputs["acos"]  = [0x1.dffffb3488a4p-1, 0x1.6c05eb219ec46p-1,
                                           0x1.ffffe7507938p-1, 0x1.ffffe78d96c87p-1]
binary64_functions_spec_inputs["acosh"] = [0x1.0001ff6afc4bap+0, 0x1.01825ca7da7e5p+0,
                                           0x1.92acc901d133fp+3, 0x1.93e3865814b01p+3]
binary64_functions_spec_inputs["asin"]  = [-0x1.0000045b2c904p-3, 0x1.6c042a6378102p-1,
                                           0x1.a6a58d55e3071p-25, 0x1.a6a58d55e3072p-25]
binary64_functions_spec_inputs["asinh"] = [-0x1.02657ff36d5f3p-2, -0x1.000276d9cf31ap-4]
binary64_functions_spec_inputs["atan"]  = [0x1.f9004c4fef9eap-4, -0x1.ffff8020d3d1dp-7,
                                           0x1.f9a746fadc626p+1, 0x1.fd5ca4d9c850ep+1]
binary64_functions_spec_inputs["atanh"] = [-0x1.ebb5133a9d9a4p-4, -0x1.e2cfb2667f17ep-9,
                                           0x1.d12ed0af1a2a4p-27, 0x1.d12ed0af1a2a5p-27]
binary64_functions_spec_inputs["cbrt"]  = [0x1.7a337e1ba1ec2p-257, -0x1.f7af4893d1d51p-616,
                                           0x1.0b0b055fab24cp-1, 0x1.0b6b16786e828p-1]
binary64_functions_spec_inputs["cos"]   = [-0x1.7120161c92674p+0, -0x1.d19ebc5567dcdp+311,
                                           0x1.054f8fb7ecd2bp-10, 0x1.05871c6ef5f9ap-4]
binary64_functions_spec_inputs["cosh"]  = [-0x1.633c654fee2bap+9, -0x1.5a364e6b98134p+9,
                                           0x1.200698cf881a2p-1, 0x1.200f9eeddc5a7p-11]
binary64_functions_spec_inputs["exp"]   = [-0x1.49f33ad2c1c58p+9, 0x1.fce66609f7428p+5,
                                           0x1.0000000000068p-52, 0x1.0000000000068p-53]
binary64_functions_spec_inputs["exp10"] = [-0x1.57449153f316ep-7, -0x1.5cd9d94d49a85p+1,
                                           0x1.14d54004e8937p-2, 0x1.14ef2dec8c0d8p-18]
binary64_functions_spec_inputs["exp2"]  = [-0x1.1a4ce073ea908p-5, -0x1.8002f29666b99p-6,
                                           0x1.423b81681e9bap+9, 0x1.428p+9]
binary64_functions_spec_inputs["log"]   = [0x1.1211bef8f68e9p+0, 0x1.008000db2e8bep+0,
                                           0x1.dcf0ee0466b06p+5, 0x1.0d7ad3a32b788p+6]
binary64_functions_spec_inputs["log10"] = [0x1.de02157073b31p-1, 0x1.feda7b62c1033p-1,
                                           0x1.5563f85c8b3bep-997, 0x1.5853b748bc157p-997]
binary64_functions_spec_inputs["log1p"] = [-0x1.2bf183e0344b2p-2, 0x1.000aee2a2757fp-9,
                                           0x1.1f8aada39e276p-6, 0x1.1f93142cb3154p-5]
binary64_functions_spec_inputs["log2"]  = [0x1.1406d79e1b574p+0, 0x1.b4ebe40c95a01p+0,
                                           0x1.fbe3592b80acdp+0, 0x1.fc187e351a8cap+0]
binary64_functions_spec_inputs["sin"]   = [-0x1.f8b791cafcdefp+4, -0x1.0e16eb809a35dp+944,
...
binary64_functions_spec_inputs["cospi"] = [-0x1.1a0a2fa299b92p+6, -0x1.f01d619f61e5bp-8,
                                           0x1.508934ccfabe7p-5, 0x1.4e4d895ac7df2p-5]
binary64_functions_spec_inputs["sinpi"] = [-0x1.45f3e53e1d707p-7, 0x0.07f16ec91c164p-1022,
                                           0x1.391b1c1cfaae5p-49, 0x1.39979a8cf1447p-49]
binary64_functions_spec_inputs["tanpi"] = [-0x1.fae7d0ef22d4ep-2, 0x1.49b79692667bp+46,
